...
const config: Config = {
  ...
  // A number limiting the number of tests that are allowed to run at the same time when using test.concurrent (default: 5)
  maxConcurrency: 20,
  ...
  testEnvironment: 'jsdom', // Use 'node' if not testing browser-like code (e.g., React)
